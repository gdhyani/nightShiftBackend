...
SYSTEM_PROMPT = """You are a liquidity mapping agent for the NightShift trading platform.
Map where liquidity pools sit -- equal highs/lows, trendline liquidity, session targets.
Respond with JSON: {"buy_side_liquidity": [1.0920], "sell_side_liquidity": [1.0810], "equal_highs": [1.0920], "equal_lows": [], "likely_target": "buy_side_1.0920"}"""
...
TOOLS = [
    ...
    {"type": "function", "function": {"name": "read_insights", "description": "Read agent insights", "parameters": {"type": "object", "properties": {"symbol": {"type": "string"}, "agent_name": {"type": "string"}}, "required": ["symbol"]}}},
