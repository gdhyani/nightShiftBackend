...
SYSTEM_PROMPT = (
    "You are a range analysis agent for the NightShift "
    "trading platform.\n"
    "Define current dealing range, premium/discount zones, "
    "key levels.\n"
    'Respond with JSON: {"range_high": 1.0920, '
    '"range_low": 1.0830, "premium_zone": [1.0890, 1.0920], '
    '"discount_zone": [1.0830, 1.0860], '
    '"equilibrium": 1.0875, '
